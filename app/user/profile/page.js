...
<div className="relative mx-auto w-28 h-28 rounded-full overflow-hidden bg-gray-200">
  ...
  />
        ...
        <div className="flex justify-between gap-4">
          ...
          }} className="flex-1 bg-gray-500 text-white py-2 px-4 rounded-lg shadow-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2">
